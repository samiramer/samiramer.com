  ...
  <div className="flex flex-col w-full max-w-lg justify-center mx-auto">
    ...
    <div className="flex flex-row flex-wrap">
      <div className="w-full md:w-2/5 leading-loose mb-8">
        We usually take on 1 project at a time to ensure that our full attention is given to our clients.  This helps us stay focused on you and your idea's realization.  Here's a sampling of projects we've worked on.
      </div>
